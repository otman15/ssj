 ...
 * </pre>
 */
public class MWC64k3a2Montgomery extends RandomStreamBase {
    ...
    */
   public MWC64k3a2Montgomery(String name) {
      this();
      this.name = name;
   }
   ...
   public String toString() {
      ...
      sb.append("The current state of MWC64k3a2Montgomery");
   ...
   public String toStringFull() {
      ...
      sb.append("MWC64k3a2Montgomery stream");
    ...
    */
   public MWC64k3a2Montgomery clone() {
      MWC64k3a2Montgomery copy = (MWC64k3a2Montgomery) super.clone();
