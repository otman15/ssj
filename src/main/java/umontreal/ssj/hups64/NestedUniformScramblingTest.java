 ...
 */
public class NestedUniformScramblingTest implements PointSetRandomization {
    ...
    * Empty constructor.
    */
   public NestedUniformScramblingTest() {
      this(null);
   }
    ...
    */
   public NestedUniformScramblingTest(RandomStream stream) {
      this(stream, 0);
   }
    ...
    */
   public NestedUniformScramblingTest(RandomStream stream, int numBits) {
      this.stream = stream;
   ...
   public void randomize(PointSet p) {
      if (p instanceof CachedPointSet) {
         ...
         if (cp.getParentPointSet() instanceof DigitalNetBase2Test) {
            ((DigitalNetBase2Test) cp.getParentPointSet()).nestedUniformScramble(stream, cp.getArray(), numBits);
            return;
         }
      }
