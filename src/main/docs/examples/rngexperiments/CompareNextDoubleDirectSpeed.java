...
public class CompareNextDoubleDirectSpeed {

   private static final long[] LFSR258_SEED = {123456789123456789L, 123456789123456789L,
         123456789123456789L, 123456789123456789L, 123456789123456789L};
   private static final long[] MWC64K3A2_SEED = {1L, 3L, 4L, 5L};
   ...
   public static void main(String[] args) throws IOException {
      ...
      if (runMode.equals("one")) {
         RUNS = 4L;
         N = totalValues / RUNS;
         filePrefix = "nextDouble_direct_vs_indirect_4Runs_";
      } else {
         RUNS = 1000L;
         N = totalValues / RUNS;
         filePrefix = "nextDouble_direct_vs_indirect_MultiRuns_";
      }
      ...
      testLFSR258(out, RUNS, N, totalValues);
      testMWC64k3a2(out, RUNS, N, totalValues);
      out.close();
   }

   private static void testLFSR258(PrintWriter out, long RUNS, long N, long totalValues) {
      ...
      for (long r = 0; r < RUNS; r++) {
         if (r % 2 == 0) {
            LFSR258.setPackageSeed(LFSR258_SEED);
            ...
            LFSR258Direct.setPackageSeed(LFSR258_SEED);
   ...
   private static void testMWC64k3a2(PrintWriter out, long RUNS, long N, long totalValues) {
      double sumDoubleIndirect = 0.0;
      double sumDoubleDirect = 0.0;
      long totalTimeIndirectDouble = 0L;
      long totalTimeDirectDouble = 0L;
      ...
      for (long r = 0; r < RUNS; r++) {
         if (r % 2 == 0) {
            MWC64k3a2.setPackageSeed(MWC64K3A2_SEED);
            ...
            MWC64k3a2Direct.setPackageSeed(MWC64K3A2_SEED);
