 ...
 * two largest observations are marked by default, and the builtin statistical
...
public class HistCollectionLatex {
   ...
   /**
    * The position of the builtin statistical legend.
    */
   private static String legendPos = "auto";

   /**
    * Controls whether the builtin statistical legend is shown in histogram
    * collections.
    */
   ...
   /**
    * Sets the position of the builtin statistical legend. Valid values are
    ...
    *
    * This setting does not apply to custom legend options passed to
    * {@link #makeHistogramLatex}; custom legend options control their own position.
    *
    * @param pos position of the builtin statistical legend
   ...
   /**
    * Sets whether the builtin statistical legend is shown in histogram
    * collections generated by {@link #writeCollection}.
    *
    * @param option {@code "builtin"} to show the builtin statistical legend, or
    ...
    * title. For {@code legendOptions}, {@code null} hides the legend,
    * {@code "builtin"} uses the builtin statistical legend, and any other nonempty
    * string is used as custom PGFPlots legend options. The builtin legend
    * position is controlled separately by {@link #setLegendPos}.
    *
    ...
    * custom PGFPlots legend options.
    *
